...
function! s:snippets()
    ...
    inoreabbrev <buffer> switch switch () {<CR>}<ESC>Ocase word:<ESC>>>obreak;<ESC>odefault:<ESC>3k0f)
    ...
    inoreabbrev <buffer> public public function name()<CR>{<CR>}<ESC>2k$Fn
    inoreabbrev <buffer> class class name<CR>{<CR>}<ESC>2kfn
endfunction
